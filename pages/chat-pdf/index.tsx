...
export default function Home() {
  ...
  const handleExport = () => {
    const input = document.getElementById('messageList');
    html2canvas(input)
       .then((canvas) => {
  ...
  return (
    <>
      <Layout>
        ...
        <footer className="m-auto p-4 hidden">
          <a href="https://twitter.com/mayowaoshin" target="_blank">
            build by Punit
          </a>
        </footer>
      </Layout>
